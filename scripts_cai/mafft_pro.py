...
"""
#$python mafft_wrapper.py ./input/pro/ ./input/mafft_pro/ .fas --thread aa
...
if __name__ == "__main__":
    if len(sys.argv) != 6:
        print
        "usage: python mafft_wrapper.py inDIR outDIR infile_ending thread DNA/aa"
        sys.exit()
    ...
    for i in os.listdir(inDIR):
        if i[-l:] == file_end and "m_"+i  not in done:
            filecount += 1
    ...
    if filecount == 0:
        print
        "No file end with", file_end, "found"
